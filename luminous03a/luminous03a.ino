...
void setup(){
  ...
  eecom.setCursor(0,0);
  eecom.print("Luminous03 EECOM");
  // set up the LCD's number of columns and rows: 
  pilot.begin(20, 4);
  // Print a message to the LCD.

    pilot.setCursor(0,0);
  pilot.print("Luminous03 pilot");
  // set up the LCD's number of columns and rows: 
...
Indicators();
  ...
  eecom.print(VData.ECharge/VData.EChargeTot);
  //eecom.print("/");
  //eecom.print(VData.EChargeTot);
  eecom.setCursor(6,2);

  eecom.print(VData.MonoProp);
  eecom.print("/");
  eecom.print(VData.MonoPropTot);  
